...
SECRET_KEY = 'django-insecure--x^#*7er77xdj_bjnai27h9k1jb=x$djc5w_-_)c*bnb3cm(lp'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'iso9001db'),
        'USER': os.environ.get('DB_USER', 'audit_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'audit_pass'),
